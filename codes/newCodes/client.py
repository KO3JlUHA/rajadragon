...
while True:
    ...
    # Screen.fill('#71ddee')
    CameraGroup.update()
    tileDraw(CameraGroup.offset.x, CameraGroup.offset.y)
    CameraGroup.CustomDraw(player)
    if pygame.key.get_pressed()[pygame.K_a] or pygame.key.get_pressed()[pygame.K_s] or pygame.key.get_pressed()[
        pygame.K_d] or pygame.key.get_pressed()[pygame.K_w]:
        Screen.blit(pygame.transform.flip(player_animation[int(frame % 4)], pygame.key.get_pressed()[pygame.K_a], 0),
                    player.rect.topleft - CameraGroup.offset)
    else:
        Screen.blit(playerimg, player.rect.topleft - CameraGroup.offset)
    # -------------------------------------------------------------
